import { Renderer, Camera, Geometry, Program, Mesh } from 'https://esm.sh/ogl@0.0.117';

const defaultColors = ['#FF6B35', '#E85D2A', '#FF8C42'];
...
function initParticles() {
  ...
  const update = t => {
    ...
    if (moveParticlesOnHover) {
      particles.position.x = -mouseRef.x * particleHoverFactor;
      particles.position.y = -mouseRef.y * particleHoverFactor;
    } else {
